...
println "EM 2021 - Finale: $em2021_gruppe_finale $em2021_gruppe_finale.class.name"
...
println "6. Runde - Halbfinale - $round_2021_07_06.dateTime"


// 7. Spieltag / Finale
def round_2021_07_11 = service.findRound(em2021, 6)
if (round_2021_07_11.isPresent()) {
    round_2021_07_11 = round_2021_07_11.get()
} else {
    round_2021_07_11 = service.addRound(em2021, '2021-07-11 21:00:00', finale)
}
println "7. Runde - Finale - $round_2021_07_06.dateTime"

def em2021_finale = service.addTeams(em2021, finale, [italien, england])
printTeams(em2021_finale)

// 6. Spieltag / Finale
service.addMatch(round_2021_07_11, '2021-07-11 21:00:00', em2021_finale, italien, england)
