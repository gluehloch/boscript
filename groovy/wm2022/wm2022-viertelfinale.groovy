...
// def wm2022_viertelfinale = service.addGroup wm2022, viertelfinale
println "Gruppe Viertelfinale: $wm2022_viertelfinale.id"

println "Neue Runde anlegen..."

def round_2022_12_09 = service.findRound(wm2022, 4)
if (round_2022_12_09.isPresent()) {
    round_2022_12_09 = round_2022_12_09.get()
} else {
    round_2022_12_09 = service.addRound(wm2022, '2022-12-09 16:00:00', viertelfinale)
}
println "Runde $round_2022_12_09.dateTime"

service.addMatch(round_2022_12_09, '2022-12-09 16:00:00', wm2022_viertelfinale, kroatien, brasilien)
service.addMatch(round_2022_12_09, '2022-12-09 20:00:00', wm2022_viertelfinale, niederlande, argentinien)

service.addMatch(round_2022_12_09, '2022-12-10 16:00:00', wm2022_viertelfinale, marokko, portugal)
service.addMatch(round_2022_12_09, '2022-12-10 20:00:00', wm2022_viertelfinale, england, frankreich)
