...
if (round_2022_12_03.isPresent()) {
    round_2022_12_03 = round_2022_12_03.get()
} else {
...
service.addMatch(round_2022_12_03, '2022-12-04 16:00:00', wm2022_achtelfinale, frankreich, polen)
service.addMatch(round_2022_12_03, '2022-12-04 20:00:00', wm2022_achtelfinale, england, senegal)

service.addMatch(round_2022_12_03, '2022-12-05 16:00:00', wm2022_achtelfinale, japan, kroatien)
service.addMatch(round_2022_12_03, '2022-12-05 20:00:00', wm2022_achtelfinale, brasilien, suedkorea)

service.addMatch(round_2022_12_03, '2022-12-06 16:00:00', wm2022_achtelfinale, marokko, spanien)
service.addMatch(round_2022_12_03, '2022-12-06 20:00:00', wm2022_achtelfinale, portugal, schweiz)
