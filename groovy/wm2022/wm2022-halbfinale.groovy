...
def wm2022_halbfinale = service.addGroup wm2022, halbfinale
println "Gruppe A: $wm2022_halbfinale.id"

wm2022_halbfinale = service.findGroup(wm2022, halbfinale);
validate wm2022_halbfinale

// def wm2022_viertelfinale = service.addGroup wm2022, viertelfinale
println "Gruppe Halbfinale: $wm2022_halbfinale.id"

println "Neue Runde anlegen..."

def round_2022_12_13 = service.findRound(wm2022, 5)
if (round_2022_12_13.isPresent()) {
    round_2022_12_13 = round_2022_12_13.get()
} else {
    round_2022_12_13 = service.addRound(wm2022, '2022-12-13 20:00:00', halbfinale)
}
println "Runde $round_2022_12_13.dateTime"

service.addMatch(round_2022_12_13, '2022-12-13 20:00:00', wm2022_halbfinale, argentinien, kroatien)
service.addMatch(round_2022_12_13, '2022-12-14 20:00:00', wm2022_halbfinale, frankreich, marokko)
