...
def round_2022_11_25 = service.findRound(wm2022, 1)
if (round_2022_11_25.isPresent()) {
    round_2022_11_25 = round_2022_11_25.get()
} else {
    round_2022_11_25 = service.addRound(wm2022, '2022-11-25 11:00:00', gruppeA)
}
println "Runde $round_2022_11_25.dateTime"

service.addMatch(round_2022_11_25, '2022-11-25 11:00:00', wm2022_gruppe_B, wales, iran)
service.addMatch(round_2022_11_25, '2022-11-25 14:00:00', wm2022_gruppe_A, katar, senegal)
service.addMatch(round_2022_11_25, '2022-11-25 17:00:00', wm2022_gruppe_A, niederlande, ecuador)
service.addMatch(round_2022_11_25, '2022-11-25 20:00:00', wm2022_gruppe_B, england, usa)

service.addMatch(round_2022_11_25, '2022-11-26 11:00:00', wm2022_gruppe_D, tunesien, australien)
service.addMatch(round_2022_11_25, '2022-11-26 14:00:00', wm2022_gruppe_C, polen, saudiArabien)
service.addMatch(round_2022_11_25, '2022-11-26 17:00:00', wm2022_gruppe_D, frankreich, daenemark)
service.addMatch(round_2022_11_25, '2022-11-26 20:00:00', wm2022_gruppe_C, argentinien, mexiko)
...
service.addMatch(round_2022_11_25, '2022-11-28 17:00:00', wm2022_gruppe_G, brasilien, schweiz)
service.addMatch(round_2022_11_25, '2022-11-28 20:00:00', wm2022_gruppe_H, portugal, uruguay)
