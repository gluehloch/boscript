...
def round_2022_11_29 = service.findRound(wm2022, 2)
if (round_2022_11_29.isPresent()) {
    round_2022_11_29 = round_2022_11_29.get()
} else {
    round_2022_11_29 = service.addRound(wm2022, '2022-11-29 16:00:00', gruppeA)
}
println "Runde $round_2022_11_29.dateTime"

service.addMatch(round_2022_11_29, '2022-11-29 16:00:00', wm2022_gruppe_A, niederlande, katar)
service.addMatch(round_2022_11_29, '2022-11-29 16:00:00', wm2022_gruppe_A, ecuador, senegal)
service.addMatch(round_2022_11_29, '2022-11-29 20:00:00', wm2022_gruppe_B, wales, england)
service.addMatch(round_2022_11_29, '2022-11-29 20:00:00', wm2022_gruppe_B, iran, usa)

service.addMatch(round_2022_11_29, '2022-11-30 16:00:00', wm2022_gruppe_D, tunesien, frankreich)
service.addMatch(round_2022_11_29, '2022-11-30 16:00:00', wm2022_gruppe_D, australien, daenemark)
service.addMatch(round_2022_11_29, '2022-11-30 20:00:00', wm2022_gruppe_C, polen, argentinien)
service.addMatch(round_2022_11_29, '2022-11-30 20:00:00', wm2022_gruppe_C, saudiArabien, mexiko)

service.addMatch(round_2022_11_29, '2022-12-01 16:00:00', wm2022_gruppe_F, kroatien, belgien)
service.addMatch(round_2022_11_29, '2022-12-01 16:00:00', wm2022_gruppe_F, kanada, marokko)
service.addMatch(round_2022_11_29, '2022-12-01 20:00:00', wm2022_gruppe_E, japan, spanien)
service.addMatch(round_2022_11_29, '2022-12-01 20:00:00', wm2022_gruppe_E, costaRica, deutschland)

service.addMatch(round_2022_11_29, '2022-12-02 16:00:00', wm2022_gruppe_H, suedkorea, portugal)
service.addMatch(round_2022_11_29, '2022-12-02 16:00:00', wm2022_gruppe_H, ghana, uruguay)
service.addMatch(round_2022_11_29, '2022-12-02 20:00:00', wm2022_gruppe_G, kamerun, brasilien)
service.addMatch(round_2022_11_29, '2022-12-02 20:00:00', wm2022_gruppe_G, serbien, schweiz)
